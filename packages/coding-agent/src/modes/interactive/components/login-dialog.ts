import { getOAuthProviders, type OAuthDeviceCodeInfo } from "@trek/ai/oauth";
import { Container, type Focusable, getKeybindings, Input, Spacer, Text, type TUI } from "@trek/tui";
