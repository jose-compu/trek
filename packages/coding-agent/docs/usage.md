...
Sessions are saved automatically to `~/.trek/agent/sessions/`, organized by working directory.
...
|----------|-------------|
| `PI_CODING_AGENT_DIR` | Override config directory; default is `~/.trek/agent` |
...
For the full rationale, read the [blog post](https://mariozechner.at/posts/2025-11-30-trek-coding-agent/).
