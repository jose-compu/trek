...
import type { AgentMessage, AgentTool } from "@trek/agent-core";
import { Agent } from "@trek/agent-core";
import type { FauxModelDefinition, FauxProviderRegistration, FauxResponseStep, Model } from "@trek/ai";
import { registerFauxProvider } from "@trek/ai";
...
export async function createHarness(options: HarnessOptions = {}): Promise<Harness> {
	...
	return {
		...
		cleanup() {
			...
			if (previousReflectiveLoopEnv === undefined) {
				delete process.env.TREK_REFLECTIVE_LOOP;
			} else {
