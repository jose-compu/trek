...
import { complete, type Message } from "@trek/ai";
import type { ExtensionAPI, SessionEntry } from "@trek/coding-agent";
import { BorderedLoader, convertToLlm, serializeConversation } from "@trek/coding-agent";
