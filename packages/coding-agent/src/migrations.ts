...
/**
 * Migrate sessions from ~/.trek/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.trek/agent/ instead of
 * ~/.trek/agent/sessions/<encoded-cwd>/. This migration moves them
