...
import { trekEnv } from "../trek-env.ts";
...
function getCallbackHost(): string {
	return typeof process !== "undefined" ? trekEnv("OAUTH_CALLBACK_HOST") || "127.0.0.1" : "127.0.0.1";
}
 ...
 * @param options.originator - OAuth originator parameter (defaults to "trek")
 */
