...
import { Agent } from "@trek/agent-core";
import { getModel, type OAuthCredentials, type OAuthProvider } from "@trek/ai";
...
// ============================================================================
// OAuth API key resolution from ~/.trek/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".trek", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.trek/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.trek/agent/auth.json
 */
...
export const PI_AGENT_DIR = join(homedir(), ".trek", "agent");

/**
 * Get an AuthStorage instance backed by ~/.trek/agent/auth.json
