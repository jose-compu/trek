...
import type { AssistantMessage, ToolResultMessage, Usage } from "@trek/ai";
import { Container, Text, type TUI } from "@trek/tui";
import { beforeAll, describe, expect, test, vi } from "vitest";
import type { AgentSessionEvent } from "../../../src/core/agent-session.ts";
import type { SessionContext, SessionEntry } from "../../../src/core/session-manager.ts";
...
type RenderSessionContextThis = {
	...
	sessionManager: { getCwd(): string; getBranch(): SessionEntry[] };
...
function createFakeInteractiveModeThis(): RenderSessionContextThis {
	...
	return {
		...
		sessionManager: { getCwd: () => process.cwd(), getBranch: () => [] },
