import { CustomEditor, type ExtensionAPI, type ExtensionContext, type KeybindingsManager } from "@trek/coding-agent";
import type { Component, EditorTheme, TUI } from "@trek/tui";
import { truncateToWidth, visibleWidth } from "@trek/tui";
