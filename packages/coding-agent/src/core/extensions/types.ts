...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@trek/coding-agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@trek/coding-agent";
	 *
...
export type InputSource = "interactive" | "rpc" | "extension" | "batch";
