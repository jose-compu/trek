...
**Source:** [`@trek/tui`](https://github.com/earendil-works/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@trek/tui";
...
```typescript
import { Container, type Focusable, Input } from "@trek/tui";
...
Import from `@trek/tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@trek/tui";
```
...
```typescript
import { matchesKey, Key } from "@trek/tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@trek/tui";
...
```typescript
import { getMarkdownTheme } from "@trek/coding-agent";
import { Markdown } from "@trek/tui";
...
For letting users pick from a list of options. Use `SelectList` from `@trek/tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@trek/coding-agent";
import { DynamicBorder } from "@trek/coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@trek/tui";
...
```typescript
import { BorderedLoader } from "@trek/coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@trek/tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@trek/coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@trek/tui";
...
import { matchesKey, truncateToWidth } from "@trek/tui";
