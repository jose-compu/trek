...
if (rootPackageJson.name !== "trek-monorepo") {
...
if (!options.skipInstall) {
	...
	console.log(`  ${join(nodeInstallDirectory, process.platform === "win32" ? "trek.cmd" : "trek")} --help`);
	...
	if (!options.skipBunInstall) {
		...
		console.log(`  ${join(bunInstallDirectory, process.platform === "win32" ? "trek.cmd" : "trek")} --help`);
	}
}
