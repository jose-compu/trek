...
All keyboard shortcuts can be customized via `~/.trek/agent/keybindings.json`. Each action can be bound to one or more keys.
...
Create `~/.trek/agent/keybindings.json`:
